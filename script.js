...
// Efecto de partículas verdes (estilo Nacional)
function createGreenParticle() {
  ...
  particle.style.boxShadow = "0 0 10px #228B22"
...
setInterval(createGreenParticle, 1500)

// Función para crear confeti verde y blanco cuando se carga la página
function createConfetti() {
  const colors = ["#228B22", "#32CD32", "#ffffff", "#90EE90"]
...
console.log("Script con colores del Nacional cargado correctamente")
